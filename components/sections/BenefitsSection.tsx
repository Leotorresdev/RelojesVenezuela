        ...
        <MotionReveal className="mx-auto mb-16 max-w-3xl text-center">
          ...
          <MotionReveal delay={0.15}>
            <p className="mt-5 text-base leading-7 text-[#f5f0e6]/70 sm:text-lg sm:leading-8">
              Diseñamos cada paso del proceso para que compres con tranquilidad y recibas tu reloj de manera segura y rápida.
            </p>
          </MotionReveal>
        </MotionReveal>
          ...
          {benefits.map((benefit, index) => {
            ...
            return (
              <motion.article
                ...
                whileHover={{ y: -8 }}
                className="group relative overflow-hidden rounded-[1.75rem] border border-white/10 bg-gradient-to-b from-[#141310] via-[#0f0e0c] to-[#0a0908] p-6 shadow-xl transition-all duration-500 hover:border-[#d4af37]/30 hover:shadow-[0_20px_50px_rgba(212,175,55,0.12)] sm:p-8"
              >
                <div
                ...
                >
                  <Icon size={24} strokeWidth={1.5} className="text-[#d4af37]" />
                </motion.div>
                ...
                <div className="absolute right-0 top-0 h-20 w-20 rounded-tr-[1.75rem] bg-gradient-to-bl from-[#d4af37]/5 to-transparent" />
              </motion.article>
            );
          })}
        </div>
          ...
          <div className="relative overflow-hidden rounded-2xl border border-[#d4af37]/15 bg-gradient-to-r from-[#d4af37]/5 via-transparent to-[#d4af37]/5 px-6 py-8 sm:px-10">
            <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-heading text-lg font-semibold text-white">Compra protegida</p>
              ...
              <div className="flex gap-8">
                <div className="text-center">
                  <p className="font-heading text-2xl font-semibold text-[#d4af37]">24h</p>
                  <p className="mt-1 text-[10px] uppercase tracking-[0.2em] text-[#f5f0e6]/50">
                    Tiempo de respuesta
                  </p>
                </div>
                <div className="text-center">
                  <p className="font-heading text-2xl font-semibold text-[#d4af37]">7 días</p>
                  <p className="mt-1 text-[10px] uppercase tracking-[0.2em] text-[#f5f0e6]/50">
                    Atención semanal
                  </p>
                </div>
                <div className="text-center">
                  <p className="font-heading text-2xl font-semibold text-[#d4af37]">100%</p>
                  <p className="mt-1 text-[10px] uppercase tracking-[0.2em] text-[#f5f0e6]/50">
                    Seguro
                  </p>
                </div>
